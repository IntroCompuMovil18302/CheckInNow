package com.checkinnow.checkinnow.Noticias.ModeloNoticias;
...
public class NoticiasAdapter extends BaseAdapter {
    ...
    public NoticiasAdapter(Context conexto, List<List<String>> datos) {
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        final View vista = inflater.inflate(R.layout.adapternoticias, null);
