...
import com.checkinnow.checkinnow.Eventos.ModeloEventos.ContantesTwoClass;
...
import static com.checkinnow.checkinnow.Eventos.ModeloEventos.ContantesTwoClass.PATHANFITRIONSTORAGE;
import static com.checkinnow.checkinnow.Eventos.ModeloEventos.ContantesTwoClass.PATHLUGARESANFITRION;
import static com.checkinnow.checkinnow.Eventos.ModeloEventos.ContantesTwoClass.REQUEST_IMAGE_CAPTURE;
import static com.checkinnow.checkinnow.Eventos.ModeloEventos.ContantesTwoClass.TAG;


public class AgregarEventoFragment extends Fragment implements DatePickerDialog.OnDateSetListener {

    private static EventosClass lugar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_agregar_eventos, container, false);
        ...
        ArrayAdapter<CharSequence> adapterNoticias = ArrayAdapter.createFromResource(getActivity(),R.array.TipoEvento,android.R.layout.simple_spinner_item);
...
//        String[] letra = {"A","B","C","D","E"};
        ...
        requestPermission(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE,
                "Se necesita acceder al almacenamiento", ContantesTwoClass.READ_EXTERNAL_STORAGE2);
    ...
    private void lanzarMapa() {
        ...
        MapaSeleccionEventoFragment mapagregarlugar = new MapaSeleccionEventoFragment();

        mapagregarlugar.setTargetFragment(AgregarEventoFragment.this, ContantesTwoClass.REQUEST_LOCATION2);
    ...
    private void agregarImagen() {
        ...
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
            ...
            startActivityForResult(pickImage, ContantesTwoClass.IMAGE_PICKER_REQUEST2);
        } else {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case ContantesTwoClass.IMAGE_PICKER_REQUEST2: {
            ...
            case ContantesTwoClass.REQUEST_LOCATION2: {
            ...
            case ContantesTwoClass.READ_EXTERNAL_STORAGE2: {   //PERMISO
                if (resultCode == RESULT_OK) {
                    Toast.makeText(getActivity(),
                            "Comencemos",
                            Toast.LENGTH_LONG).show();
